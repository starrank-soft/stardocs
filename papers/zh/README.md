...
| 03 | [Edit-as-Code：让 AI 像 Coding Agent 一样完成视频剪辑](./03-edit-as-code.md) | [Edit Video as Code：将视频工程映射为 Coding Agent 可读写的虚拟文件视图](./article-edit-video-as-code.md) | Agent-Computer Interface 与创作系统 |
