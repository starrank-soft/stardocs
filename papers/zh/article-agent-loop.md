...
在以已采集素材为起点的视频剪辑工作流中，创作者主要进行素材选择、时间组织和后期包装。生成模型进入创作流程后，新素材也会在剪辑过程中随时产生：一条产品视频做到一半，可能发现缺少合适的产品特写，于是临时生成图片，再把图片扩展为几秒钟的动态镜头；旁白、音乐、字幕和 Motion Graphics 也会陆续补充。视频项目由剪辑、理解和生成共同推进，素材集合与时间线都在持续变化。
