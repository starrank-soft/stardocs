...
创作软件正在经历相似的变化。[Descript](https://www.descript.com/underlord)、[ChatCut](https://chatcut.io/docs/what-is-chatcut) 等产品已经开始实践：Agent 可以理解素材、生成初剪，也可以通过自然语言直接修改时间线。Agent 的工作对象逐渐变成一个会被反复修改、继续加工和最终交付的创作工程。
