...
| 网感与受众 | 套用平台规则、案例模式和已知偏好 | 结合平台语境、内容类型和目标人群判断何时遵循或打破惯例 |
...
第一，Agent 需要**主动观察**，而不是一次性吞下整条视频。它应当能围绕候选剪点快速播放前后窗口、逐帧拖动、比较两个版本，并在发现问题后扩大观察范围。播放、seek、scrub 调度和缩略图获取因此不只是交互性能问题，也是 AI 时间感知接口的一部分。
